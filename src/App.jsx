...
const PROCESS = [{ n: '01', t: 'Listen', d: 'Audit your current motion and goals.', icon: '👂' }, { n: '02', t: 'Design', d: 'Interaction prototypes you feel, not just see.', icon: '🖱️' }, { n: '03', t: 'Build', d: 'Spring physics, magnetic elements, 60fps dev.', icon: '⚙️' }, { n: '04', t: 'Measure', d: 'Ship, test, and tune the motion that works.', icon: '📊' }]
